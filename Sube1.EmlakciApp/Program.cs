...
namespace Sube1.EmlakciApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            SatilikEv se = new SatilikEv(4000000, 3, "Satılık Ev", 110, 60);
            SatilikEv se1 = new SatilikEv(7000000, 2, "Satılık Ev", 120, 70);
            SatilikEv se2 = new SatilikEv(9000000, 4, "Satılık Ev", 140, 80);
